...
class Population:
    def __init__(self,agent,popSize,interSpeciesBreeding=0.001,fitnessGoal=100,initiallyConnected=False,stepSize=0.3,MRGeneral=0.8,MRShift=0.9,MRRandom=0.1,MREnableDisable=0.01,MRAddNode=0.03,MRAddConnection=0.05,c1=1,c2=0.4,requiredDistance=3,maxStaleness=15):
        ...
        for i in range(self.popSize):
            ...
            if(self.initiallyConnected == False):
    ...
    def evaluate(self):
        ...
        # Delete stale or extinct species
        i = len(self.species) - 1;
        while(i >= 0):
